...
parser.add_argument('-mn', '--models-name', help="The name of the model", default='openworld_discrete2')
...
parser.add_argument('-ep', '--episodes', help="Number of the episodes to observe", default=3000)

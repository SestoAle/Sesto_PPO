...
parser.add_argument('-mn', '--models-name', help="The name of the model", default='*really_big_im, really_big_3d')
...
parser.add_argument('-ep', '--episodes', help="Number of the episodes to observe", default=10000)

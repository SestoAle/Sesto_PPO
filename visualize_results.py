...
parser.add_argument('-mn', '--models-name', help="The name of the model", default='final_im_2,questoe*con*3,play_2,play_2_positional,play_2_positional_sample')
...
parser.add_argument('-ep', '--episodes', help="Number of the episodes to observe", default=18000)

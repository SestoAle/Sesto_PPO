...
parser.add_argument('-mn', '--models-name', help="The name of the model", default='openworld_discrete_coin3,openworld_discrete_coin4')
...
parser.add_argument('-ep', '--episodes', help="Number of the episodes to observe", default=30000)

...
parser.add_argument('-mn', '--models-name', help="The name of the model", default='adversarial,ranger_no_norm, ranger_par*')
...
parser.add_argument('-ep', '--episodes', help="Number of the episodes to observe", default=20000)

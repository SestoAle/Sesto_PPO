...
def print_traj(traj):
    ...
    if (ep_trajectory[-1, 5:7] == [0.5, 0.5]).all():
        color = 'g'
    elif (ep_trajectory[-1, 5:7] == [0, 1]).all():
        color = 'b'
    elif (ep_trajectory[-1, 5:7] == [1, 0]).all():
        color = 'y'
    elif (ep_trajectory[-1, 5:7] == [0.3, 0.7]).all():
        color = 'm'
    elif (ep_trajectory[-1, 5:7] == [0.7, 0.3]).all():
        color = 'k'

    print(ep_trajectory[-1, 5:7])

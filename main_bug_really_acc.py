...
parser.add_argument('-mn', '--model-name', help="The name of the model", default='vaffanculo_im')
...
parser.add_argument('-rm', '--reward-model', help="The name of the reward model", default='vaffanculo_im_36000')

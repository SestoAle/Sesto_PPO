...
parser.add_argument('-gn', '--game-name', help="The name of the game", default='envs/BugEnv_Really_Acc_HardCoded_v3')
...
parser.add_argument('-rm', '--reward-model', help="The name of the reward model", default='vaffanculo_3000')
...
if __name__ == "__main__":
    ...
    with graph.as_default():
        ...
        agent = PPO(sess, input_spec=input_spec, network_spec=network_spec, obs_to_state=obs_to_state,
                    action_type='discrete', action_size=10, model_name=model_name, p_lr=1e-5, v_batch_fraction=0.33,
                    v_num_itr=10, memory=memory, c2=0.01,
                    v_lr=1e-5, recurrent=args.recurrent, frequency_mode=frequency_mode, distribution='gaussian',

...
parser.add_argument('-mn', '--model-name', help="The name of the model", default='play_4_500_4')
...
if __name__ == "__main__":
    ...
    curriculum = {
        ...
        "parameters": {
            ...
            "win_weight": [[1], [1], [1]],
            "reward_weights": [[0, 0, 0.3, 0.5, 0.6, 0.7, 0.8, 0.9, 1], [0, 0, 0.3, 0.5, 0.6, 0.7, 0.8, 0.9, 1],
                               [0, 0, 0.3, 0.5, 0.6, 0.7, 0.8, 0.9, 1]],
            "goal_area": [4, 4, 4]
        }
    }

...
shading_filter = ShadingFilter(shading='flat', ambient_coefficient=(1, 1, 1, 1), diffuse_coefficient=(1, 1, 1, 1),
                                   specular_coefficient=(1, 1, 1, 1), shininess=100, light_dir=(10, 5, - 5),
                                   ambient_light=(1, 1, 1, 1), diffuse_light=(1, 1, 1, 1),
                                   specular_light=(1, 1, 1, 1), enabled=False)
